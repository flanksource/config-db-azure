module github.com/flanksource/config-db-azure
...
require (
	...
	github.com/flanksource/config-db/api v0.0.1419
	github.com/flanksource/config-db/api/plugin v0.0.1419
	...
	github.com/flanksource/kopper v1.0.30 // indirect
...
replace github.com/flanksource/config-db/api => ../config-db/api/v1

replace github.com/flanksource/config-db/api/plugin => ../config-db/api/plugin
